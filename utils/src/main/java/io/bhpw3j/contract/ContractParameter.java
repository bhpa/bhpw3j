...
import io.bhpw3j.contract.ContractParameter.ContractParameterDeserializer;
import io.bhpw3j.contract.ContractParameter.ContractParameterSerializer;
...
public class ContractParameter {
    ...
    public static ContractParameter signature(byte[] signature) {
        if (signature.length != BHPConstants.SIGNATURE_SIZE_BYTES) {
            throw new IllegalArgumentException("Signature is expected to have a length of " +
                    BHPConstants.SIGNATURE_SIZE_BYTES + " bytes, but had " +
                    signature.length + ".");
        }
    ...
    public static ContractParameter hash160(ScriptHash hash) {
        if (hash.length() != BHPConstants.SCRIPTHASH_LENGHT_BYTES) {
            throw new IllegalArgumentException("A Hash160 parameter expects a value of length " +
                    BHPConstants.SCRIPTHASH_LENGHT_BYTES);
        }
    ...
    public static ContractParameter hash256(ScriptHash hash) {
        if (hash.length() != BHPConstants.ASSET_ID_LENGHT_BYTES) {
            throw new IllegalArgumentException("A Hash256 parameter expects a value of length " +
                    BHPConstants.ASSET_ID_LENGHT_BYTES);
        }
