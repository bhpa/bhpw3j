...
/**
 * BHP BRC-6 wallet file.
 */
public class BRC6Wallet {
    ...
    private List<BRC6Account> accounts;
    ...
    public BRC6Wallet(String name, String version, ScryptParams scrypt, List<BRC6Account> accounts, Object extra) {
        this.name = name;
    ...
    public List<BRC6Account> getAccounts() {
        return accounts;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BRC6Wallet)) return false;
        BRC6Wallet that = (BRC6Wallet) o;
