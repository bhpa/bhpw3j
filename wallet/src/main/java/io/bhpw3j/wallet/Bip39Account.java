...
import io.bhpw3j.crypto.MnemonicUtils;
import io.bhpw3j.crypto.SecureRandomUtils;

import static io.bhpw3j.crypto.Hash.sha256;

/**
 * Class encapsulating a BIP-39 compatible BHP account.
 */
public class Bip39Account extends Account {
    ...
    /**
     * Generates a BIP-39 compatible BHP account. The private key for the wallet can
     ...
     * @return A BIP-39 compatible BHP account.
     */
