...
public class ECDSASignature {
    ...
    public ECDSASignature toCanonicalised() {
        if (!isCanonical()) {
            ...
            return new ECDSASignature(r, BHPConstants.CURVE.getN().subtract(s));
        } else {
            return this;
        }
    }
