...
public class RawTransactionOutput extends BhpSerializable {
    ...
    public static RawTransactionOutput createBhpTransactionOutput(String value, String address) {
        return new RawTransactionOutput(BhpAsset.HASH_ID, value, address);
    }
