 ...
 * constructed from the OpCode {@link io.bhpw3j.constants.OpCode#PUSHBYTES64} and the transaction
 * signature.
 */
public class RawInvocationScript extends BhpSerializable {
     ...
     * io.bhpw3j.constants.OpCode#PUSHBYTES64}. The opcode is not added automatically. Better even,
