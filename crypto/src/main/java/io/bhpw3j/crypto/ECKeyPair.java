...
import static io.bhpw3j.constants.BHPConstants.PUBLIC_KEY_SIZE;
...
public class ECKeyPair {
    ...
    /**
     * Constructs the BHP address from this key pairs public key.
     * The address is constructed ad hoc each time this method is called.
     *
     * @return the BHP address of the public key.
     */
    ...
    public BigInteger[] sign(byte[] transactionHash) {
        ...
        ECPrivateKeyParameters privKey = new ECPrivateKeyParameters(privateKey, BHPConstants.CURVE);
    ...
    public ECDSASignature signAndGetECDSASignature(byte[] transactionHash) {
        ...
        // in bitcoin and ethereum we would/could use .toCanonicalised(), but not in BHP, AFAIK
