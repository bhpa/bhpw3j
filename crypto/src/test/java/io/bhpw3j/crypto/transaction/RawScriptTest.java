...
import io.bhpw3j.crypto.SampleKeys;
...
import static io.bhpw3j.constants.OpCode.PUSHBYTES64;
...
public class RawScriptTest {
    ...
    public void testDeserializeWithWitness() throws InvalidAlgorithmParameterException,
        ...
        RawScript script = BhpSerializableInterface.from(buf.array(), RawScript.class);
    ...
    public void testGetScriptHash() {
        ...
        // Test with script hash generated by bhpn-js
