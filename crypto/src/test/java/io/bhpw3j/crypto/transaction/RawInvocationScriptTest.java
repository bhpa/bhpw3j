...
public class RawInvocationScriptTest {
    ...
    public void testDeserialize() throws IllegalAccessException, InstantiationException,
        ...
        RawInvocationScript script = BhpSerializableInterface.from(serializedScript, RawInvocationScript.class);
        ...
        script = BhpSerializableInterface.from(serializedScript, RawInvocationScript.class);
        ...
        buf.put((byte)0x01);
        buf.put(message);
        script = BhpSerializableInterface.from(buf.array(), RawInvocationScript.class);
        assertArrayEquals(message, script.getScript());
    }
