...
import static io.bhpw3j.constants.OpCode.CHECKSIG;
import static io.bhpw3j.constants.OpCode.PUSH2;
import static io.bhpw3j.constants.OpCode.PUSH3;
import static io.bhpw3j.constants.OpCode.PUSHBYTES33;
...
public class RawVerificationScriptTest {
    ...
    public void testDeserialize() throws InvalidAlgorithmParameterException,
        ...
        RawVerificationScript script = BhpSerializableInterface.from(serializedScript, RawVerificationScript.class);
        ...
        script = BhpSerializableInterface.from(serializedScript, RawVerificationScript.class);
        ...
        buf.put((byte)0x01);
        buf.put(message);
        script = BhpSerializableInterface.from(buf.array(), RawVerificationScript.class);
        assertArrayEquals(message, script.getScript());
    }
