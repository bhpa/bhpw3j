...
public class BhpGetClaimable extends Response<BhpGetClaimable.Claimables> {
    ...
    public static class Claim {
        ...
        public Claim(String txId, int index, BigInteger bhpValue, BigInteger startHeight, BigInteger endHeight,
        ...
        public boolean equals(Object o) {
            ...
            return index == claim.getIndex() &&
                    ...
                    bhpValue.compareTo(claim.getBhpValue()) == 0 &&
        ...
        @Override
        public int hashCode() {
            return Objects.hash(txId, index, bhpValue, startHeight, endHeight, generatedGas, systemFee, unclaimedGas);
        }
