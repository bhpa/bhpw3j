...
import io.bhpw3j.io.BhpSerializableInterface;
...
public class ContractTransactionTest {
    ...
    public void serialize_Unsigned() {
        ...
        RawTransaction tUnsigned = new ContractTransaction.Builder()
                ...
                .output(new RawTransactionOutput(BhpAsset.HASH_ID, "10.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
                .output(new RawTransactionOutput(BhpAsset.HASH_ID, "90.0", "AKYdmtzCD6DtGx16KHzSTKY8ji29sMTbEZ"))
    ...
    public void serialize_Signing_CheckMultiSig_10_PublicKeys_7_Signatures() {
        ...
        RawTransaction tUnsigned = new ContractTransaction.Builder()
                ...
                .output(new RawTransactionOutput(BhpAsset.HASH_ID, "100.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
                .output(new RawTransactionOutput(BhpAsset.HASH_ID, "900.0", multiSigAddress))
                .build();
    ...
    public void deserialize_CheckSig() throws IllegalAccessException, InstantiationException {
        ...
        ContractTransaction tx = BhpSerializableInterface.from(rawTransactionArray, ContractTransaction.class);
        assertNotNull(tx);
    ...
    public void deserialize_CheckMultiSig() throws IllegalAccessException, InstantiationException {
        ...
        RawTransaction rawTransactionObj = BhpSerializableInterface.from(rawTransactionArray, ContractTransaction.class);
    ...
    public void verify_Signature() throws SignatureException {
        ...
        RawTransaction unsignedTx = new ContractTransaction.Builder()
                .input(new RawTransactionInput("9feac4774eb0f01ab5d6817c713144b7c020b98f257c30b1105062d434e6f254", 0))
                .output(new RawTransactionOutput(BhpAsset.HASH_ID, "100.0", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"))
                .output(new RawTransactionOutput(BhpAsset.HASH_ID, "900.0", address))
                .build();
    ...
    public void serialize_then_deserialize_without_scripts() throws IllegalAccessException, InstantiationException {
        ...
        tx = BhpSerializableInterface.from(tx.toArray(), ContractTransaction.class);
        ...
        assertEquals(BhpAsset.HASH_ID, tx.getOutputs().get(0).getAssetId());
        assertEquals(BhpAsset.HASH_ID, tx.getOutputs().get(1).getAssetId());
