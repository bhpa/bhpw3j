...
public class ContractAbiLoaderTest {
    ...
    public void abiWithoutAddress_test1() {
        ...
        assertThat(
            c1.getFunction("Name"),
            is(of(new BhpContractFunction("Name", Collections.emptyList(),
    ...
    public void abiWithoutAddress_test2() {
        ...
        assertThat(
            ...
            is(
                of(
                    new BhpContractFunction("Name", Arrays.asList(
        ...
        assertThat(
            ...
            is(
                of(
                    new BhpContractFunction("Description", Arrays.asList(
