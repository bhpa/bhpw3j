...
import static io.bhpw3j.contract.ContractFunctionProperties.unpackIsPayable;
import static io.bhpw3j.contract.ContractFunctionProperties.unpackNeedsDynamicInvoke;
import static io.bhpw3j.contract.ContractFunctionProperties.unpackNeedsStorage;
...
public class ContractFunctionPropertiesTest {
    ...
    public void test_Deserialize() throws IllegalAccessException, InstantiationException {
        ...
        ContractFunctionProperties result = BhpSerializableInterface.from(raw, ContractFunctionProperties.class);
    ...
    public void testSerializeAndDeserialize1() throws IllegalAccessException, InstantiationException {
        ...
        ContractFunctionProperties deserializedProps = BhpSerializableInterface.from(rawProperties,
